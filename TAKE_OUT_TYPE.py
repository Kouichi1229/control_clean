...
CORP=['COMPANY','COMPANY,','INCORPORATED','CORPORATION','CORP.','CORP','INC',
 ...
 'KABUSHIKI-KAISHA','AKTIENGESELLSCHAFT','SPA','INCORP']


LLC=['PLLC','LLC','L.L.C.','PLC.','PLC','HF.','OYJ','A.E.','NYRT.',
...
'CORPORATIOB','CORPORATED','CORPORATIN']

WRONG_WORDS_INC=['INCOPORATION','INCOROPORATION','INCORPORAION','INCORPORATI','INCORPORATIION','INCROP'
 'INCORPORATON','INCORPORTAION','INCORPORTION','INCORPOTRATION','INCORPROATION','INCORPORATION','INE'
]
...
WRONG_WORDS_AG=['AKTIENGELLSCHAFT']

WRONG_WORDS_GMBH=['GBMH','GMBJ']

WRONG_WORDS_LLC=['LCC']

WRONG_WORDS_LTD=['LITD.','LDT',' LTE','LTP.','LTDL','LGD','LRD','TLD','LED','LID']
